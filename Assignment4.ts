...
class Dejimon {
    ...
    constructor(name: string, type: string, height: number, weight: number, ability: number) {
        this.name = name;
        this.type = type;
        this.height = height;
        this.weight = weight;
...
function allStorage(): Array<string> {
...
function displayAll(): void {
    ...
    for (i = 0; i < allDejimons.length; i++) {
        ...
        let deji: Array<string> = JSON.parse(allDejimons[i][1]);
...
function add(): void {
    let name: string = (document.getElementById('addname') as HTMLInputElement).value;
    //@ts-ignore
    let weight: number = (document.getElementById('addweight') as HTMLInputElement).value;
    //@ts-ignore
    let height: number = (document.getElementById('addheight') as HTMLInputElement).value;
    let type: string = (document.getElementById('addtype') as HTMLInputElement).value;
    //@ts-ignore
    let ability: number = (document.getElementById('addability') as HTMLInputElement).value;
...
function seeMore(key: string): void {
